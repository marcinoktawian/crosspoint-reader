...
inline const std::vector<SettingInfo>& getSettingsList() {
  static const std::vector<SettingInfo> list = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_BUTTONS_LOCK_MODE, &CrossPointSettings::buttonsLockMode,
                          {StrId::STR_LONG_PRESS_BEHAVIOR_OFF, StrId::STR_BUTTONS_LOCK_BACK_POWER}, "buttonsLockMode",
